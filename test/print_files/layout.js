...
var Layout = function() {
    ...
    var layoutImgPath = Metronic.getAssetsPath() + 'admin/layout2/img/';

    var layoutCssPath = Metronic.getAssetsPath() + 'admin/layout2/css/';
    ...
    // Helper function to calculate sidebar height for fixed sidebar layout.辅助函数计算侧边栏布局的边栏高度
    ...
    var handleSidebarToggler = function() {
        ...
        // handle the search bar close处理搜索栏关闭 
        $('.page-sidebar').on('click', '.sidebar-search .remove', function(e) {
            e.preventDefault();
            $('.sidebar-search').removeClass("open");
        });

        // handle the search query submit on enter press处理搜索查询提交在回车
